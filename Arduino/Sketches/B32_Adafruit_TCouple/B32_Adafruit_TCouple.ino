...
const char szFileDate[]    = "10/9/23b";
/***************************************************
...
Adafruit_MAX31855 TCouple31855[]= {Adafruit_MAX31855(wTCoupleSPIClk, wTCoupleCS[0], wTCoupleSPIDataOut),

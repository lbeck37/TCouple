//Beck, lv_demo_widgets.c, 2/18/24c
/**
...
static void profile_create(lv_obj_t * parent)
{
    ...
    lv_label_set_text(dsc, "B32_Elecrow_Demo.ino, 2/18/24f, lv_demo_widgets.c");
    ...
    lv_label_set_text(call_label, "(208) 336-9802");
